            ...
            <div class="slick_res1r">
              <div v-for="(item,index) in cate" :key="index">
                <li
                  ...
                  :class="{currCate:currCateIndex==index}"
                >
                  <div class="ico"></div>
                  <h4>{{item}}</h4>
                </li>
          ...
          .slick_res1r {
            ...
            .l1 {
              ...
              .ico {
                ...
                left: 0;
                top: 0;
                background: url("http://www.chuangwudao.com/templates/cn/images/index1.png")
